...
export default function Assignment4Chatbot() {
  return (
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <Link href="/assignment4" className="text-blue-600 dark:text-blue-400 hover:underline">
                ← Back to Assignment 4
              </Link>
              <h1 className="text-3xl font-bold text-gray-800 dark:text-white mt-2">Assignment 4 Chatbot</h1>
